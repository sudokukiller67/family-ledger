...
export const dictionaries = {
  ru: {
    ...
    newMemberName: "Имя",
    cat_transfer: "Денежный перевод",
    recipient: "Кому",
    recipientPlaceholder: "Имя получателя",
    transfersTo: "Кому ушли деньги",
  ...
  pl: {
    ...
    newMemberName: "Imię",
    cat_transfer: "Przelew",
    recipient: "Do kogo",
    recipientPlaceholder: "Imię odbiorcy",
    transfersTo: "Do kogo poszły pieniądze",
    activeMember: "Aktywny uczestnik",
    depositAmount: "Kwota wpłaty",
    treasury: "Skarbiec",
    expenses: "Wydatki",
    incomes: "Przychody",
    percentOfTotal: "z całości",
    selectFromList: "Z listy",
  ...
  en: {
    ...
    newMemberName: "Name",
    cat_transfer: "Money transfer",
    recipient: "Recipient",
    recipientPlaceholder: "Recipient name",
    transfersTo: "Where money went",
